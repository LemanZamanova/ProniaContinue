    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Update(int? id)
        {
            ...
            UpdateProductVM productVM = new UpdateProductVM
            {
                ...
                PrimaryImage = product.ProductImage.FirstOrDefault(pi => pi.IsPrimary == true).Image
            };
            return View(productVM);
        }
        [HttpPost]
        public async Task<IActionResult> Update(int? id, UpdateProductVM productVM)
        {
            ...
            if (productVM.MainPhoto != null)
            {
                ...
                ProductImage? exitedMain = existed.ProductImage.FirstOrDefault(p => p.IsPrimary == true);
                exitedMain.Image.DeleteFile(_env.WebRootPath, "assets", "images", "website-images");
                existed.ProductImage.Remove(exitedMain);
